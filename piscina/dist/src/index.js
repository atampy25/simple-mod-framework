...
class DirectlyTransferable {
	...
	get [((_value = new WeakMap()), common_1.kTransferable)]() {
...
class ArrayBufferViewTransferable {
	...
	get [((_view = new WeakMap()), common_1.kTransferable)]() {
		return __classPrivateFieldGet(this, _view).buffer
	}
	get [common_1.kValue]() {
...
class Piscina extends eventemitter_asyncresource_1.default {
	...
	get utilization() {
		...
		const totalMeanRuntime = __classPrivateFieldGet(this, _pool).runTime.mean * __classPrivateFieldGet(this, _pool).runTime.totalCount
