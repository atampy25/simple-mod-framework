...
```jsonc
{
	...
	"frameworkVersion": "1.2.0", // The framework version the mod is designed for
	...
	"localisedLines": { // Allows you to link specific lines to a runtime ID for use in certain filetypes (like entities)
